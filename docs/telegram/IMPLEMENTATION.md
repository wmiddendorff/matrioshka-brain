...
All tables live in `~/.matrioshka-brain/data/telegram.db` with WAL journal mode.
...
CREATE TABLE telegram_messages (
  id TEXT PRIMARY KEY,              -- UUID generated by Matrioshka Brain
...
1. Connect to `~/.matrioshka-brain/bot/telegram.sock`
...
4. Spawn detached child with `MATRIOSHKA_BRAIN_DAEMON=1` env var
