...
Communication between MCP tools and the bot daemon uses newline-delimited JSON over a Unix socket at `~/.mudpuppy/bot/telegram.sock`.
...
import {
  ...
  parseResponse,
  serialize,
} from 'mudpuppy/telegram/protocol';
...
interface TelegramMessage {
  id: string;               // UUID generated by Mudpuppy
