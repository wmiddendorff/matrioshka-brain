...
- `.mcp.json` - Generated by `setup.sh`, gitignored (machine-specific)

**Setup:**
- `setup.sh` - Portable setup script (install, build, init, .mcp.json generation)
...
- ✅ `docs/security/` - Complete (README, API, IMPLEMENTATION, TESTING)
